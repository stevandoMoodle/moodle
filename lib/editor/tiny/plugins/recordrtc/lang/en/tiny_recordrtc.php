...
$string['insecurealerttitle'] = 'Insecure connection!';
$string['insecurealert'] = 'Your browser might not allow this plugin to work unless it is used either over HTTPS or from localhost';
...
$string['recordagain_desc'] = 'You have a recorded data, if you do a record again the data will be deleted.<br>Do you want to record again?';
