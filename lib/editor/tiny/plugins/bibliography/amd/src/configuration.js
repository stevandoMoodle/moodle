...
const configureMenu = (menu) => {
    ...
    if (!menu.bibliography) {
        ...
        // menu.reference.items = `${insertBibliographyButtonName} ${menu.reference.items}`;
        // menu.reference.items = `${insertCitationButtonName} ${menu.reference.items}`;
    }
...
const configureToolbar = (toolbar) => {
    ...
    return toolbar.map((section) => {
        if (section.name === 'reference') {
            ...
            section.items.unshift(insertBibliographyButtonName, insertCitationButtonName);
        }
