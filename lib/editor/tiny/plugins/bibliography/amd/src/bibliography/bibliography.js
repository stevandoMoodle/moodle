...
prefetchStrings(component, [
    // Modal title.
    'modalTitle:insert',
    'modalTitle:bibliography',
    'modalTitle:citation',
    'modalTitle:update',
    'modalTitle:defaultstylenotenabled',
    'modalTitle:usedstylenotavailable',
    'modalTitle:usedstylenotselected',
]);
...
export default class Bibliography extends Setter {
    ...
    async displayDialogue() {
        ...
        if (this.defaultStyleNotEnabled) {
            this.modal.setTitle(this.langStrings['modalTitle:defaultstylenotenabled']);
            showElement([Selectors.elements.warning], this.root);
            return;
        } else if (this.usedStyleNotAvailable) {
            // Set modal title.
            this.modal.setTitle(this.langStrings['modalTitle:usedstylenotavailable']);

            // Handle warning message.
            const warning = this.root.querySelector(Selectors.elements.warning);
            warning.innerHTML = await getString('modalWarning:usedstylenotavailable', component, ucFirst(this.usedStyle));
            showElement([Selectors.elements.warning], this.root);
