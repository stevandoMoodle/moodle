...
export class EventHandler {
    ...
    createClickListenerHandler = (event) => {
        ...
        if (editBio) {
            ...
            this.modal.setTitle(this.langStrings['modalTitle:update']);
        ...
        if (resetBibliography) {
            ...
            this.modal.setTitle(this.langStrings['modalTitle:insert']);
        ...
        if (backToBibliography) {
            ...
            this.modal.setTitle(this.langStrings['modalTitle:bibliography']);
