...
export class EventHandler {
    ...
    createClickListenerHandler = async(event) => {
        ...
        if (deleteBibliography) {
            this.selectedStyle.deleteBibliography({...this, deleteBibliography});
        }
