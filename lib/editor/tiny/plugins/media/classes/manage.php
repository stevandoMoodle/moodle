...
$PAGE->set_url('/lib/editor/tiny/plugins/media/classes/manage.php');
...
$mform = new tiny_mediamanager_manage_form(null,
    ['options' => $options, 'draftitemid' => $itemid, 'files' => $filenames, 'elementid' => $elementid,
        'removeorphaneddrafts' => $removeorphaneddrafts], 'post', '', ['id' => 'tiny_mediamanager_form']);
...
if ($data = $mform->get_data()) {
    if (!empty($data->deletefile)) {
        ...
        $mform = new tiny_mediamanager_manage_form(null,
            ...
            'post', '', ['id' => 'tiny_mediamanager_form']);
    }
}
