...
$string['check_title'] = 'Accessbility check confirmation';
$string['check_desc'] = 'Do you want check the accessibility issues for everyting?<br><i><b>Cancel</b></i> will check the accessibility issues for the selected element or where the cursor is located.';
...
$string['nowarningonselected'] = 'Congratulations, the selected element has no accessibility issues found!';
