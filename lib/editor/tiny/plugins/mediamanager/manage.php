...
$title = get_string('managefiles', 'tiny_mediamanager');
...
$mform = new tiny_mediamanager_manage_form(null,
    array('options' => $options, 'draftitemid' => $itemid, 'files' => $filenames, 'elementid' => $elementid,
        'removeorphaneddrafts' => $removeorphaneddrafts), 'post', '', array('id' => 'tiny_mediamanager_form'));
...
if ($data = $mform->get_data()) {
    if (!empty($data->deletefile)) {
        ...
        $mform = new tiny_mediamanager_manage_form(null,
            ...
            'post', '', array('id' => 'tiny_mediamanager_form'));
    }
}
