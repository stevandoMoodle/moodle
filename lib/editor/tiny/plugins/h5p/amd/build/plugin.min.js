...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,FilterContent=_interopRequireWildcard(FilterContent),Commands=_interopRequireWildcard(Commands),Configuration=_interopRequireWildcard(Configuration);var _default=new Promise((async resolve=>{const tinyMCE=await(0,_loader.getTinyMCE)(),setupCommands=await Commands.getSetup();return tinyMCE.PluginManager.add("".concat(_common.component,"/plugin"),(editor=>{FilterContent.setup(editor),setupCommands(editor)})),resolve(["".concat(_common.component,"/plugin"),{configure:Configuration.configure}]),tinyMCE}));return _exports.default=_default,_exports.default}));
