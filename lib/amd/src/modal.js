...
export default class Modal {
    ...
    setBody(value) {
        ...
        if (typeof value === 'string') {
            ...
            .then((result) => {
                FilterEvents.notifyFilterContentUpdated(body);
                this.getRoot().trigger(ModalEvents.bodyRendered, this);
                dispatchEvent(ModalEvents.bodyRendered, this, this.modal[0]);
                return result;
            })
            .then(() => {
                this.bodyPromise.resolve(body);
    ...
    show() {
        ...
        .then((backdrop) => {
            ...
            dispatchEvent(ModalEvents.shown, this, this.modal[0]);
    ...
    hide() {
        this.getBackdrop().done((backdrop) => {
            ...
            dispatchEvent(ModalEvents.hidden, this, this.modal[0]);
        });
    }
