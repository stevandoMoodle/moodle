...
module.exports = grunt => {
    ...
    const handler = function() {
        ...
        if (grunt.file.exists(eslintConfigPath)) {
            eslintConfig = grunt.file.readJSON(eslintConfigPath);
        }

        // Set ignorePatterns.
        eslintConfig.ignorePatterns = eslintIgnores;
